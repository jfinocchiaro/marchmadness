...
pickle.dump(new_feature_vec, open('pickled_files/all_feature_vec_random.p', 'wb'))
pickle.dump(train_x, open('pickled_files/all_train_x_random.p', 'wb'))
pickle.dump(train_y, open('pickled_files/all_train_y_random.p', 'wb'))
pickle.dump(training_data, open('pickled_files/train_x_random.p', 'wb'))
pickle.dump(training_labels, open('pickled_files/train_y_random.p', 'wb'))
pickle.dump(test_data, open('pickled_files/test_x_random.p', 'wb'))
pickle.dump(test_labels, open('pickled_files/test_y_random.p', 'wb'))
