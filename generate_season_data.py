...
def init_feature_vector():
	...
	with open(detailed_results) as fi:
		with open('game-by-game-feature-vectors.csv', 'wb') as fileout_vec:
			with open('game-by-game-results.csv', 'wb') as fileout_labels:
				...
				for lines in fi:
					...
					#crappy IO implementation
					fileout_vec.write(season)
					fileout_vec.write(',')
					fileout_vec.write(w_team)
					fileout_vec.write(',')
					for stat in data[season][w_team].values():
						if type(stat) is list:
							fileout_vec.write(str(stat[0]))
							fileout_vec.write(',')
						else:
							fileout_vec.write(str(stat))
							fileout_vec.write(',')
					fileout_vec.write('\n')
					fileout_labels.write('1\n')

					fileout_vec.write(season)
					fileout_vec.write(',')
					fileout_vec.write(l_team)
					fileout_vec.write(',')
					for stat in data[season][l_team].values():
						if type(stat) is list:
							fileout_vec.write(str(stat[0]))
							fileout_vec.write(',')
						else:
